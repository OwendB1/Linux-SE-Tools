...
- Distrobox mode creates a container (default name `torch-wrapper`), auto-enters it for all containerized setup/run steps, installs Torch dependencies inside it, and launches Torch from the host paths.
